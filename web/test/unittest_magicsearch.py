...
class QSPreProcessorTC(EnvBasedTC):
    ...
    def test_quoted_queries(self):
        ...
        queries = [
            ...
            (u'Utilisateur pr̩nom "Jean Paul"', ('CWUser E WHERE E firstname %(text)s', {'text': 'Jean Paul'})),
    ...
    def test_process_query(self):
        ...
        queries = [
            ...
            (u'CWUser pr̩nom cubicweb', (u'CWUser E WHERE E firstname %(text)s', {'text': 'cubicweb'},)),
